...
Welcome! Here I include my solutions to exercises and questions in the textbook <u>*Quantum Computation and Quantum Information* by Michael A. Nielsen and Isaac L. Chuang</u>, which is one of the fundamental textbooks for quantum computing beginner. I also include some extended material that is relevant and useful to the content of this textbook. Hope these information help the quantum computation and quantum information community. 
...
Chapter2-extension/index
```

Please read the following disclaimer (created with ChatGPT) carefully before using the solutions provided in this webpage:
